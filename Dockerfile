# Stage 1: Clone the repository (Bust cache for hybrid JS/Python)
FROM alpine/git AS cloner
WORKDIR /repo
RUN git clone https://github.com/AlexaInc/tgchannel24x7.git . && git reset --hard origin/master # V1.0.5
